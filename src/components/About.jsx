...
const About = () => {
  return (
    ...
    <div
      id="About"
      className="AboutContainer h-auto bg-[#0a192f] flex flex-col pt-[80px] mt-[80px] pb-10"
    >
      <h2 className="text-3xl text-basicText font-sans font-bold ml-5 mt-10">About Me:</h2>
      <p className="ml-5 text-basicText mt-2 mr-5 font-sans">
